    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun add(view: View){
            ...
            serv.insertaccount(
                ...
                phone.text.toString()
            ).enqueue(object : Callback<List<userDB>>{

                override fun onResponse(call: retrofit2.Call<List<userDB>>, response: retrofit2.Response<List<userDB>>) {
                ...
                override fun onFailure(call: retrofit2.Call<List<userDB>>, t: Throwable) {
